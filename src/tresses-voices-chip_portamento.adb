...
package body Tresses.Voices.Chip_Portamento is
   ...
   begin
      if Do_Init then
         ...
         Analog_Oscillator.Set_Shape (Osc, Analog_Oscillator.Square);
      ...
      Analog_Oscillator.Set_Param (Osc, 0, Params (2));
      Analog_Oscillator.Render (Osc, Buffer, Current_Phase_Incr);

      for Index in Buffer'Range loop
         Sample := S32 (Buffer (Index));
